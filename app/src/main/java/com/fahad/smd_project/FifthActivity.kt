...
class FifthActivity : AppCompatActivity(), SnacksAdapter.OnItemClickListener {
    ...
    override fun onItemClick(item: AddItem) {
        ...
        val clickedItemRef = database.push()
        clickedItemRef.setValue(item)
            .addOnSuccessListener {
                Toast.makeText(this, "Item information stored in Firebase", Toast.LENGTH_SHORT).show()
            ...
            .addOnFailureListener { e ->
                Toast.makeText(this, "Failed to store item information: ${e.message}", Toast.LENGTH_SHORT).show()
            }
    }
}